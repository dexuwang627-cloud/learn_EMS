        ...
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <section className="bg-gradient-to-br from-zinc-800/80 to-zinc-900 border border-emerald-900/30 rounded-2xl p-6 md:p-8 space-y-8">
                <div className="flex items-center gap-3 border-b border-zinc-700/50 pb-4">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold text-amber-100 flex-1">通訊協議映射 (Protocol Mapping) 與任務</h2>
                </div>
                ...
                <div className="space-y-6 text-amber-100/90 leading-relaxed">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mt-6">
                        <div className="bg-zinc-800 rounded-xl p-6 border border-zinc-700/50">
                            ...
                            <p className="mb-2 text-amber-100"><strong>FC3ReadRegistersTask</strong></p>
                        ...
                        <div className="bg-zinc-800 rounded-xl p-6 border border-zinc-700/50">
                            ...
                            <p className="mb-2 text-amber-100"><strong>FC16WriteRegistersTask</strong></p>
                            <p className="text-sm text-amber-100/70">
