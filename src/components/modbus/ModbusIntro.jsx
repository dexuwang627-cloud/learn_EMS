    ...
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <section className="space-y-6">
                <h2 className="text-2xl font-semibold text-amber-100 flex items-center gap-3">
                    <Cpu className="w-6 h-6 text-amber-100/70" />
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-6">
                    <div className="bg-zinc-800 rounded-xl p-6 border border-zinc-700/50 hover:border-amber-500/30 transition-colors">
                        ...
                        <p className="text-amber-100/90 mb-4 h-24">
                        ...
                        <ul className="space-y-4">
                            <li className="bg-zinc-900/50 p-4 rounded-lg border border-zinc-700/50 flex gap-3">
                                <Network className="w-5 h-5 text-amber-100/70 shrink-0 mt-0.5" />
                                <div>
                                    <strong className="text-amber-50 block mb-1">Modbus/TCP</strong>
                                    <span className="text-sm text-amber-100/70">走網路線 (Ethernet)。就像是用 Email 溝通，只要有 IP 位置（例如 192.168.1.100）和 Port 號，就能快速傳遞訊息。</span>
                                </div>
                            </li>
                            <li className="bg-zinc-900/50 p-4 rounded-lg border border-zinc-700/50 flex gap-3">
                                <Cable className="w-5 h-5 text-amber-100/70 shrink-0 mt-0.5" />
                                <div>
                                    <strong className="text-amber-50 block mb-1">Modbus/RTU</strong>
                                    <span className="text-sm text-amber-100/70">走實體序列線 (RS485)。就像是用「傳閱板夾」把多台設備串在一起 (Daisy-chain)，必須指定每一台機器的「站號 (Unit ID)」，例如 1號機、2號機。</span>
                                </div>
                            </li>
                        </ul>
                    </div>
